...
export default function Header() {
  return (
    <>
    <nav className={`navbar navbar-expand-lg p-4 ${styles.navBar}`}>
      ...
      <ul className="navbar-nav ms-auto mb-2  mb-lg-0">
        <li className="nav-item">
          <Link className="nav-link active text-white fw-bolder" aria-current="page" to='about'>ABOUT</Link>
                ...
                <li className="nav-item">
          <Link className="nav-link active text-white fw-bolder " aria-current="page" to='portfolio'>PORTFOLIO</Link>
        </li>
        <li className="nav-item">
